# example.py — elastik Tier 1 plugin specimen
# Not auto-loaded. Install via:
#   curl -X PUT http://localhost:3005/lib/example \
#     -H "Authorization: Bearer $ELASTIK_TOKEN" --data-binary @example.py
#   curl -X PUT http://localhost:3005/lib/example/state \
#     -H "Authorization: Bearer $ELASTIK_APPROVE_TOKEN" --data-binary "active"
